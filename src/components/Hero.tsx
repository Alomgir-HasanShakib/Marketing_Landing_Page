      ...
      <div className="flex justify-center items-center h-screen w-[100vw]">
        ...
        <div className="z-10 flex justify-center items-center relative my-20 ">
          <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center text-center space-y-10">
            <h1 className="text-[2.5rem]  xl:text-[5rem] text-primary font-semibold  tracking-wide leading-snug  drop-shadow-[100px_100px_100px_] shadow-xl">
              Skyrocket Your Business with High Impact Digital Solutions{" "}
            </h1>
            <p className="text-neutral/80  font-normal text-base lg:text-xl">
            ...
            <button className="inline-flex h-12 animate-shimmer items-center justify-center rounded-md border border-secondary bg-[linear-gradient(110deg,#235347,45%,#10B981,55%,#235347)] bg-[length:200%_100%] px-10 py-8 text-neutral transition-colors focus:outline-none focus:ring-2 focus:ring-primary/20 focus:ring-offset-2 focus:ring-offset-primary/40 text-2xl font-bold gap-4 hover:scale-95 hover:duration-300 hover:transition-all">
